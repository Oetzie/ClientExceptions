<?php
	...
	class ClientExceptionsExceptionsUpdateFromGridProcessor extends ClientExceptionsExceptionsUpdateProcessor {
		/**
		 * @access public.
		 * @return Mixed.
		 */
	...
	return 'ClientExceptionsExceptionsUpdateFromGridProcessor';
