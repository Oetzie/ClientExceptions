<?php
	...
	$_lang['clientexceptions.exceptions_desc']							= 'Hier kun je alle IP uitzonderingen beheren voor jouw website. Een IP uitzondering is bedoelt om iemand aan de hand van zijn of haar IP nummer toegang tot de website te verlenen of weigeren.';
	...
	$_lang['clientexceptions.label_ipnumber_desc']						= 'Het IP nummer van de uitzondering. Voor een wildcard in het IP nummer gebruik %, gebruik een ^ om een IP reeks te starten (bv ^172.0.) of gebruik $ om een IP reeks te eindigen (bv .0.1$).';
